...
// An OBJECT is an instance of a class. (Objects have fields and methods, and are instantiated, i.e. created, with the [new] keyword.)
...
class Person {
    ...
    // --> the class field has two String data types
    // --> the class field has one method
    public String firstName; // ---> declare a reference object firstname
    public String lastName;  // ---> declare a reference object lastname
    // Extra examples more fields for a Person to have when instantiated(created)
    private int age;
    public String relationship;

    // Properties can alse me METHODS, e,g
    public String sayHello() {
        return String.format("Hello from %s %s!", firstName, lastName);

        // Let's make that a more ral-world-ish example: Users only provide us a firstNamea and lastName on registration, but not an age or relationship.
    }
    ...
    // Now user has registered and we want to create an object with all of the potential fields
        public Person(String inputFirstName, String inputLastName, int inputAge, String inputRelationship){
        firstName = inputFirstName;
        lastName = inputLastName;
        age = 0;
        relationship = "undefined";
    ...
    public static void main(String[] args) { // ---> static means universal and it can't be changed
        //Created INSTANCE Oof a person
        Person Danny = new Person(); // --> the new operator dynamically allocates memory for an object so it can be reference later.
        // Filled in the properties with values:
        Danny.firstName = "Danny";  // ---> here I am assigning values to field firstname
        Danny.lastName = "Turner";
        Danny.age = 39; // --> integer
        Danny.relationship = "Married"; // --> string
        // ---> here I am assigning values to field lastname
        System.out.println(Danny.sayHello());
        System.out.println("Danny firstName = " + Danny.firstName);
        System.out.println("Danny lastName = " + Danny.lastName);
        // prints "Hello from Rick Sanchez!"

        // created a new INSTANCE of a person
        Person Myah= new Person();
        Myah.firstName = "Myah";
        Myah.lastName = "Turner";
        System.out.println(Myah.sayHello());

        System.out.println(Math.PI);
        System.out.println("Math.PI = " + Math.PI); // --> in order to use to soutv you must use (class.field.soutv)
        // Danny.lastName.soutv will print out line below
        System.out.println("Danny firstName = " + Danny.firstName);
...
//        String Userinput = scanner.nextLine(); // ---> use this for Strings
//        int userInput = scanner.nextInt(); // ---> use this for integer



    }
    // CONSTRUCTORS
    // --> constructor are methods but not all method are constructors.
    // -- user register with only 2 pieces of information
    // --> before using default constructor and assigning field manually.
